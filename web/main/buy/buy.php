    ...
    <div id="container">
        <div id="contents">
                                    ...
                                    <td>
                                        <select id='kind' option_product_no="13547" option_select_element="ec-option-select-finder" option_sort_no="1" option_type="T" item_listing_type="S" option_title="색상&amp;사이즈" product_option_area="product_option_13547_0" name="option1" id="product_option_id1" class="ProductOption0" option_style="select" required="true"><option value="11" link_image="">-- [필수] 색상&amp;사이즈 선택 --</option><option value="11" link_image="">---------------------------------------------</option>
                                            <?php
                                                for($j=0;$j<$i;$j++){
                                                    for($k=0;$k<7;$k++){
                                                echo '<option value=" '.$ColorSizename[$k][$l].' "> '.$color[$j].' ['.$size[$k].'] 재고:--'.$ColorSizecount[$j][$k].'</option>';
                                            }
                                         }
            ...
            echo"<input type ='hidden' name='my_save' value='".$point."'>";
                                    ?>
            <a href='../pay/pay.php' onclick="submit()" method="post"><img class="smp-btn-cart" src="./img/btn_cart_w.jpg"></a> 
                                    
                                    
                                        
                                    <a href='#' onclick="submit()"><img class="smp-btn-cart" src="./img/btn_buy.jpg"></a>
...
<!-- #########quickL######### -->
                <div id="quickL"></div>buy
                <div id="quickR">
                    <div style=" position:fixed;bottom:50px; right:50px; z-index:10000;"> <p><a onclick="$(&#39;html, body&#39;).animate( { scrollTop:0 }, &#39;slow&#39; );" href="javascript:void(0);"><img src="./img/topbotton.png" alt="" ismodify="1"></a></p></div>
                </div>
                <hr class="layout">
