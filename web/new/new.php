...
$conn=mysql_connect($dbServer,$dbUser,$dbPass) or die("new.php err");
$sql="SELECT * FROM shoppingmall.".$clothes_tbl." WHERE type='new'";
$page_size=8;
...
<div id="pictures">
 ...
 <?php
        if($page>1){
          echo "<a class='L_no' href='".htmlspecialchars("./main.php?id=new&page=".urlencode($page-1))."'> back </a><br>";
        }

        if( ($page<($total_page))  ){
       echo "<a class='R_no' href='".htmlspecialchars("./main.php?id=new&page=".urlencode($page+1))."'>  front </a>";
      }
  ?>
`
</div>
